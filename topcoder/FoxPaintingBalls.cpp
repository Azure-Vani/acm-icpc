...
class FoxPaintingBalls {
	...
	long long theMax(long long R, long long G, long long B, int N) {
		...
		if (S % 3 == 1) {
			long long l = 0, r = G + R + B;
			while (l <= r) {
				long long mid = (l + r) >> 1;
				double g = t;
				if (g * (double)mid <= d) {
					long long l1 = R - t * mid, l2 = G - t * mid, l3 = B - t * mid;
					if (l1 + l2 + l3 >= mid) 
						l = mid + 1;
					else
						r = mid - 1;
...
// BEGIN CUT HERE
	...
	void test_case_6() { long long Arg0 = 0LL; long long Arg1 = Arg0 + 1; long long Arg2 = Arg0 + 2; int Arg3 = 2; long long Arg4 = 3LL; verify_case(6, Arg4, theMax(Arg0, Arg1, Arg2, Arg3)); }
